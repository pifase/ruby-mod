...
public class RubyOreBlock extends RubiesModElements.ModElement {
	@ObjectHolder("rubies:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(RubiesModElements instance) {
		super(instance, 7);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 1)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(1, 3, 3, 32))));
		}
	}
}
